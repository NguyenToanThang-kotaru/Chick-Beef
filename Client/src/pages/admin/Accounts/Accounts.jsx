  ...
  return (
    <div >
      ...
      <div className="bg-[#FFF8F0] p-4 rounded-2xl shadow-md">
          <Table
            data={[
              { ID: <img src={pd} alt="eye" className="w-25 h-25 cursor-pointer" />, Username: 123456789, Password: "Newwwwwwwwwwww", State: "Gôddddddddd", Role: "JohnDoe", Position: "123-456-7890", watch: <img src={eye} alt="eye" className="w-6 h-6 cursor-pointer" onClick={()=>setShowWatchAccount(true)}/>,edit: <img src={Edit} alt="eye" className="w-6 h-6 cursor-pointer" onClick={()=>setShowEditAccount(true)} />,Delete: <img src={Delete} className="w-6 h-6 cursor-pointer"/>},
              { ID: <img src={pd} alt="eye" className="w-25 h-25 cursor-pointer" />, Username: 123456789, Password: "Newwwwwwwwwwww", State: "Gôddddddddd", Role: "JohnDoe", Position: "123-456-7890", watch: <img src={eye} alt="eye" className="w-6 h-6 cursor-pointer" onClick={()=>setShowWatchAccount(true)}/>,edit: <img src={Edit} alt="eye" className="w-6 h-6 cursor-pointer" onClick={()=>setShowEditAccount(true)} />,Delete: <img src={Delete} className="w-6 h-6 cursor-pointer"/>},
              { ID: <img src={pd} alt="eye" className="w-25 h-25 cursor-pointer" />, Username: 123456789, Password: "Newwwwwwwwwwww", State: "Gôddddddddd", Role: "JohnDoe", Position: "123-456-7890", watch: <img src={eye} alt="eye" className="w-6 h-6 cursor-pointer" onClick={()=>setShowWatchAccount(true)}/>,edit: <img src={Edit} alt="eye" className="w-6 h-6 cursor-pointer" onClick={()=>setShowEditAccount(true)} />,Delete: <img src={Delete} className="w-6 h-6 cursor-pointer"/>},
              { ID: <img src={pd} alt="eye" className="w-25 h-25 cursor-pointer" />, Username: 123456789, Password: "Newwwwwwwwwwww", State: "Gôddddddddd", Role: "JohnDoe", Position: "123-456-7890", watch: <img src={eye} alt="eye" className="w-6 h-6 cursor-pointer" onClick={()=>setShowWatchAccount(true)}/>,edit: <img src={Edit} alt="eye" className="w-6 h-6 cursor-pointer" onClick={()=>setShowEditAccount(true)} />,Delete: <img src={Delete} className="w-6 h-6 cursor-pointer"/>},
          ]}
